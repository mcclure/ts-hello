// Fork of https://github.com/hongru/canvas2image, MIT license
// Adds support for non-2d contexts
 ...
 */
const Canvas2Image = (function (contextType:string) {
    if (!contextType)
        contextType = "2d";
    ...
    function scaleCanvas(canvas, width, height) {
        ...
        let retCtx = retCanvas.getContext(contextType);
    ...
    function getContext(canvas) {
        const attributes = contextType == "2d" ?
            undefined :
